...
## Prerequisites
- Basic familiarity with Java, Python, and machine learning is required, knowledge of Apache Maven (or similar build automation tool) will be helpful, yet is not mandatory. Basic familiarity with Docker Desktop, and the concepts of virtualisation, container, and images, is required.
...
- **Required Software:** Java, Maven, Python, Docker Desktop
